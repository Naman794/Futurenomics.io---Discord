...
class GeneralCommands(commands.Cog):
    ...
    async def start(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.response.send_message(embed=build_success_embed("Welcome to Web3 Teacher Bot", f"Profile ready for {user.get('username', interaction.user.name)}. Try /help or /learn bitcoin."))
    ...
    async def about(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.response.send_message("I teach Web3 basics, show market data, chart Binance pairs, fetch crypto news, and send daily educational newsletters.")
