...
CREATE INDEX IF NOT EXISTS idx_alerts_active ON user_alerts(is_active, symbol);
CREATE INDEX IF NOT EXISTS idx_market_snapshots_symbol ON market_snapshots(symbol, captured_at);
CREATE INDEX IF NOT EXISTS idx_command_logs_user ON command_logs(discord_user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_market_pulse_logs_guild ON market_pulse_logs(discord_guild_id, sent_at);
